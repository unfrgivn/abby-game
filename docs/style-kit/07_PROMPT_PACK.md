# 07 Prompt Pack (Concept Art + Asset Generation)

## How to use
- Pick a template.
- Replace `[SUBJECT]`, `[SCENE]`, `[MOOD]`.
- Append the **Global Style Stamp** and the **Palette**.
...
## Recommended camera phrasing
- “top-down 3/4 view, ~60 degree tilt, gameplay readable, simple shapes”
- For turnarounds: “orthographic front/side/back, clean background”
...
- “small pond with stepping stones and a rope bridge”

---

## C) Environment concept: Beach Cove zone
**Template**
Top-down 3/4 environment concept: [SCENE]. Sand, shells, driftwood, tiny dock, shallow water gradient (very subtle), playful beach props. Chunky shapes, flat painted materials, calm bright palette. No text.
...
## F) NPC set: 6 friendly critters
**Template**
A set of 6 stylized 3D critter NPC concepts on a neutral background; each is simple and readable from above; big eyes; rounded shapes; flat colors; small accessory per critter (cap, scarf, sticker, floatie). No text.
...
## H) Prop sheet: Park set dressing
**Template**
3D prop sheet: bench, picnic table, signpost arrows, notice board, cones, flags, lantern string. Flat colors, chunky shapes, minimal texture. Neutral background. No text.
...
## K) Icon set (hand-drawn)
**Template**
Set of 30 game icons, hand-drawn thick outline, filled shapes, consistent style. Subjects: talk, collect, photo, fish, shell, hat, kite, backpack, map, home, friend, quest, heart, star. Palette locked. No text.

---

## L) VFX reference (simple particles)
**Template**
VFX concept sheet: small dust puff, gentle sparkle, sticker pop burst, tiny confetti. Soft shapes, minimal particles, calm energy. Palette limited. Dark and light background variants. No text.

---

## Prompt “knobs” (how to iterate)
- If outputs get too detailed: add “low detail, large shapes, no microdetail.”
